...
CREATE TABLE `appointment` (
  `appointment_id` int(11) NOT NULL PRIMARY KEY,
  `doctor_Specialization` varchar(255) DEFAULT NULL,
  `doctor_id` int(11) DEFAULT NULL,
  `patient_id` int(11) DEFAULT NULL,
  `consultancy_fees` int(11) DEFAULT NULL,
  ...
  FOREIGN KEY(`doctor_id` )REFERANCES doctors;
FOREIGN KEY (`patient_id`)REFERANCES patient
...
INSERT INTO `appointment` ( `appointment_id` , `doctor_Specialization` , `doctor_id` , `patient_id` , `consultancyFees`, `appointment_date` , `appointment_time`, `posting_date`, `patient_Status` , `doctor_Status` , `updation_date` ) VALUES
...
CREATE TABLE `doctors` (
  ...
  `doctor_specilization` varchar(255) DEFAULT NULL,
  `doctor_name` varchar(255) DEFAULT NULL,
  `doctor_address` longtext DEFAULT NULL,
  `doctor_fees` varchar(255) DEFAULT NULL,
  `doctor_contactnumber` bigint(11) DEFAULT NULL,
  `doctor_email` varchar(255) DEFAULT NULL,
  `doctor_password` varchar(255) DEFAULT NULL,
  `doctor_creation_date` timestamp NULL DEFAULT current_timestamp(),
  `doctor_updation_Date` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp();
...
INSERT INTO `doctors` ( `doctor_id` ,  `doctor_specilization` ,  `doctor_name` , `doctor_address` ,  `doctor_fees` ,  `doctor_contactnumber` ,  `doctor_email` ,  `doctor_password` ,  `doctor_creation_date` ,  `doctor_updation_Date` ) VALUES
...
CREATE TABLE `doctorslog` (
  ...
  `doctor_ip` binary(16) DEFAULT NULL,
  `doctor_login_time` timestamp NULL DEFAULT current_timestamp(),
  `doctor_logout` varchar(255) DEFAULT NULL,
  `doctor_status` int(11) DEFAULT NULL,
FOREIGN KEY(`doctor_id` ) REFERANCES doctors
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `doctors_specilization` (
  `specialization_id` int(11) NOT NULL,
  `doctor_specilization` varchar(255) DEFAULT NULL,
  `doctor_specialization_creation_date` timestamp NULL DEFAULT current_timestamp(),
  `doctor_specialization_updation_date` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `doctorspecilization` ( `specialization_id` , `doctor_specilization` , `doctor_specialization_creation_date` , `doctor_specialization_updation_date` VALUES
...
CREATE TABLE patients (
  ...
  patient_contact_number bigint(10) DEFAULT NULL,
  patient_email varchar(200) DEFAULT NULL,
  patient_gender varchar(50) DEFAULT NULL,
  patient_add mediumtext DEFAULT NULL,
  patient_age int(10) DEFAULT NULL,
  patient_medhis mediumtext DEFAULT NULL,
  creation_date timestamp NULL DEFAULT current_timestamp(),
  updation_date timestamp NULL DEFAULT NULL ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO patients (`patient_id`, `doctor_id`, `patient_name`, `patient_contact_number`, `patient_email`, `patient_gender`, `patient_add`, `patient_age`, `patient_medhis`, `CreationDate`, `updation_date`) VALUES
