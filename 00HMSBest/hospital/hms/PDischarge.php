...
$sql=mysqli_query($con,"select doctors.doctorName as docname,Patients.patient_name as pname,appointment.*  from appointment join doctors on doctors.doctors_id=appointment.doctors_id join Patients on Patients.patient_id=appointment.patient_id ORDER BY appointmentDate ASC");*/
...
<a href="view-medhistory.php?viewid=<?php echo $row['patient_id'];?>"><i class="fa fa-eye"></i></a>
