								...
								<div class="col-sm-4">
									<div class="panel panel-green no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle; Text-white">Total Patient </h2>
										
											<p class="cl-effect-1">
												<a href="Dtotal_patients.php">
													View Patient Record
												</a>
											</p>
										</div>
									...
									<div class="panel panel-yellow no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Total Appointments</h2>
																						<?php $result1 = mysqli_query($con,"SELECT * FROM appointment where docEmail='".$_SESSION['dlogin']."'");
...
?>
								...
								<div class="col-sm-4">
									<div class="panel panel-green no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-paperclip fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Patient Record</h2>
										
											<p class="cl-effect-1">
												<a href="DSview-patient.php">
													View Patient Record
												</a>
											</p>
										</div>
