...
$patage=$_POST['patage'];
$medhis=$_POST['medhis'];
$sql=mysqli_query($con,"insert into patients(doctors_id,patient_name,patient_contact_number,patient_email,patient_gender,patient_add,patient_age,patient_medhis) values('$docid','$patname','$patcontact','$patemail','$gender','$pataddress','$patage','$medhis')");
if($sql)
{
