...
if(isset($_POST['submit']))
  {
   ...
   $pres=$_POST['pres'];
      ...
      $query.=mysqli_query($con, "insert medical_history(patient_id,BloodPressure,BloodSugar,Weight,Temperature,MedicalPres,doctors_id)value('$vid','$bp','$bs','$weight','$temp','$pres','9')");
    if ($query) {
    echo '<script>alert("Medicle history has been added.")</script>';
    echo "<script>window.location.href ='Dview-patient.php'</script>";
  }
  else
    {
...
<html lang="en">
	<head>
		<title>Doctor | Add Medical History</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Doctor | Add Medical History </h1>
</div>
<ol class="breadcrumb">
<li>
<span>Doctor</span>
...
<li class="active">
<span> Patients Medical History</span>
</li>
</ol>
</div>
</section>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Medhis <span class="text-bold">Patients</span></h5>
...
<tr>
    <th>Patient ID :</th>
    <td>
    <input name="viewid" placeholder="patient Id" class="form-control wd-450" required="true"></td>
  </tr> 
      <tr>
