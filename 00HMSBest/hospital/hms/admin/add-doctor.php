...
$gender=$_POST['gender'];
$sql=mysqli_query($con,"insert into doctors(specilization_id,doctorName,address,docFees,contactno,docEmail,password,STATUS,gender) values('$docspecialization','$docname','$docaddress','$docfees','$doccontactno','$docemail','$password', '1', '$gender')");
if($sql)
{
...
echo "<script>alert('Doctor info additio Unsuccessful');</script>";
}
}
?>
<!DOCTYPE html>
